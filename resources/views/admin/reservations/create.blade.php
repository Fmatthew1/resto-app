    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.reservations.store') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Reservation Index</a>
            </div>
            ...
            <div class="max-w-md mx-auto">
                <form>
                  <div class="mb-4">
                    ...
                    class="appearance-none border border-gray-300 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:border-blue-500" placeholder="">
                  </div>
                      @error('first_name')
                  ...
                  <div class="sm:col-span-6 pt-5 mb-4">
                    ...
                    class="appearance-none border border-gray-300 rounded w-full py-4 px-6 leading-tight focus:outline-none focus:border-blue-500" placeholder="">
                  </div>
                      @error('email')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                      @enderror
                  <div class="mb-4">
                    ...
                    <input id="tel_number" type="tel_number" class="appearance-none border border-gray-300 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:border-blue-500" placeholder="">
                  </div>
                      @error('tel_number')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                      @enderror
