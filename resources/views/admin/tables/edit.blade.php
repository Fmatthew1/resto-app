            ...
            <div class="max-w-md mx-auto">
                <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                  ...
                  <div class="mb-4">
                    ...
                    <input id="name" type="text"name="name" value="{{ $table->name }}"
                  ...
                  <div class="mb-4">
                    ...
                    <input id="guest_number" type="number" name="guest_number" value="{{ $table->guest_number }}"
                     class="appearance-none border border-gray-300 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:border-blue-500">
                  </div>
                      @error('guest_number')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                  ...
                  <div class="sm:col-span-6 pt-5 mb-4">
                    ...
                    <div class="mt-1">
                      <select id="location" name="location" class="multi-select block w-full mt-1">
